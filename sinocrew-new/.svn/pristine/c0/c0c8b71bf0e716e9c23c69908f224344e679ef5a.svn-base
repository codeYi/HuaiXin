  ...
  methods: {
    ...
    removeThis(scope){
      ...
      switch(routerpath){
        ...
        case "/securityinsurance": var url="social/deleteInsured";var str="参保人员"; var area=scope.row.name;break;
        case "/securityinfo": var url="social/deleteInfo";var str="社保信息"; var area=scope.row.name;break;
      }
      this.$store.state.allDialog.sure=true
      this.$store.state.sureData.title="提示"
