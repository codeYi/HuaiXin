    ...
    <div class="head">
      ...
      <div class="border-common head-content">
        <el-row class="my-row">
          ...
          <el-col :span="3"><input type="text" v-model="list.name" :readonly="edit.baseInfo?true:false" :class="edit.baseInfo?'':'border'" @change="getEnName(list)"></el-col>
    ...
    <div class="body">
      ...
      <div class="border-common head-content">
        <el-row class="my-row">
          ...
          <el-col :span="5"><input type="text" v-model="homeData.bank" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'" @change="changeBank(homeData)"></el-col>
          
          <el-col :span="2"><label for=""><p>Bank NO</p></label></el-col>
          <el-col :span="5"><input type="text"  v-model="homeData.number" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>

          <el-col :span="2"><label for=""><p><span>Account</span><span>Name(CN)</span></p></label></el-col>
          <el-col :span="3"><input type="text"  v-model="homeData.name_cn" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'" @change="changeCnName(homeData)"></el-col>

          
          
          <el-col :span="2"><label for=""><p><span>Account</span><span>Name(EN)</span></p></label></el-col>
          <el-col :span="3"><input type="text"  v-model="homeData.name_en" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>
        ...
        <el-row class="my-row">
          ...
          <el-col :span="5"><input type="text" v-model="homeData.english" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>

          <el-col :span="2"><label for=""><p>联行号</p></label></el-col>
          <el-col :span="5"><input type="text" v-model="homeData.line_number" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>
          
          <el-col :span="2"><label for=""><p>D.O.B</p></label></el-col>
          <el-col :span="3"><input type="text" v-model="homeData.birthday" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>
          
          <el-col :span="2"><label for=""><p>Swift</p></label></el-col>
          <el-col :span="3"><input type="text"  v-model="homeData.swift" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>
          
        </el-row>
        <el-row class="my-row">
          <el-col :span="2"><label for=""><p>Bank(ShortName)</p></label></el-col>
          <el-col :span="5"><input type="text" v-model="homeData.short_name" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>

          <el-col :span="2"><label for=""><p>TEL</p></label></el-col>
          <el-col :span="5"><input type="text"  v-model="homeData.telnumber" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>
          
          <el-col :span="2"><label for=""><p>Relation</p></label></el-col>
          <el-col :span="3"><input type="text" v-model="homeData.relation" :readonly="edit.bodyInfo?true:false" :class="edit.bodyInfo?'':'border'"></el-col>

          <el-col :span="2"><label for=""><p>变更人/时间</p></label></el-col>
          <el-col :span="3"><span class="white-space" style="line-height:40px;display:inline-block;width:100%;height:100%;background:#fff;text-indent:10px;height:36px;" v-show="homeData.changer||homeData.change_time" :title="homeData.changer+'/'+homeData.change_time">{{homeData.changer}}/{{homeData.change_time}}</span></el-col>
        </el-row>
      </div>
    </div>
...
export default {
  ...
  methods:{
    ...
    getEnName(value){
      if(value.name){
        this.apiPost("privilege/zw2py",{chinese:value.name}).then(res=>{
          value.english=res.english
        })
      }
    },
    changeBank(value){
      this.$set(value,"line_number","")
    },
    changeCnName(value){
      if(value.name_cn){
        this.apiPost("privilege/zw2py",{chinese:value.name_cn}).then(res=>{
          value.name_en=res.english
        })
      } 
      if(value.name_cn==this.list.name){
        if(/^(^[1-9]\d{7}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])\d{3}$)|(^[1-9]\d{5}[1-9]\d{3}((0\d)|(1[0-2]))(([0|1|2]\d)|3[0-1])((\d{4})|\d{3}[Xx])$)$/.test(this.list.id_number)){
          value.birthday=this.list.id_number.slice(6,10)+"/"+this.list.id_number.slice(10,12)+"/"+this.list.id_number.slice(12,14)
        }else{
          _g.toMessage(this,"warning","身份证号格式不正确")
        }
        this.$set(value,"relation","本人")
      }else{
        this.$set(value,"relation","")
        this.$set(value,"birthday","")
      }
    },
    saveThis(str){
      if(str=="base"){
